...
Clicking any matrix cell selects it, including a red cell with missing data. The HUD
then shows the decimal-degree latitude (`lat`) and longitude (`lon`) of that tile's
geographic center.
...
cells are painted red, making the complete geographic extent and every coverage gap
visible.
