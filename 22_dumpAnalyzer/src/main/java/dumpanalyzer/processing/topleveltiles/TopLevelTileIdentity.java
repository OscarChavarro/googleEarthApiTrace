...
public final class TopLevelTileIdentity implements Comparable<TopLevelTileIdentity> {
    ...
    @Override
    public int compareTo(TopLevelTileIdentity other) {
        if (other == null) {
            return 1;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TopLevelTileIdentity other)) return false;
    ...
    private boolean sameVertices(TopLevelTileIdentity other) {
