...
public final class TopLevelTileNeighborDetector {
    private static final double BORDER_CENTER_EPSILON = 1e-4;

    private TopLevelTileNeighborDetector() {
    }
    ...
    public static void populateNeighbors(Frame frame) {
        ...
        for (int i = 0; i < tiles.size(); i++) {
            ...
            TopLevelTileSet globeLevelTileSet = tile == null ? null : tile.getGlobeLevelTileSet();
    ...
    private static TriangleMeshVertexComparator.Direction detectDirection(TopLevelTileSet a, TopLevelTileSet b) {
    ...
    private record Candidate(int tileIndex, TileInstance tile, TopLevelTileSet globeLevelTileSet) {}
}
