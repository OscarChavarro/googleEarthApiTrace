...
public final class QuadtreeDrawPlanner {
    ...
    public static DrawCommand commandForNode(QuadtreeNode node, PyramidalImageInstance instance, double relativeScale) {
        return new DrawCommand(node, worldCorners(node, instance, relativeScale));
    }
