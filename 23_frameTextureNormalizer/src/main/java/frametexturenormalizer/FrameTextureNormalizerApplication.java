...
import frametexturenormalizer.io.OfflineOutputPathResolver;
...
public final class FrameTextureNormalizerApplication {
    ...
    private static void renderOffline(FrameTextureNormalizerState model, String outputPath, int width, int height) {
        try {
            ...
            List<String> outputPaths = OfflineOutputPathResolver.buildOfflineOutputPaths(outputPath, frames.size());
