...
public final class AutomaticGrouper {
    public void run(MatrixMergerModel model) {
        if (model == null) {
            return;
        }
    ...
    private boolean runRetryMergeSweep(MatrixMergerModel model) {
    ...
    private boolean runCutSweep(MatrixMergerModel model) {
